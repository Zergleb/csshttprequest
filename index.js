    ...
    chr.parse = function(r) {
        ...
        try {
            ...
            for(var i = 0; i < rules.length; i++) {
                try {
                    var arrgh = rules.item ? rules.item(i) : rules[i];
                    var ord = arrgh.selectorText.match(chr.MATCH_ORDINAL)[1];
                    var val = arrgh.style.backgroundImage.match(chr.MATCH_URL)[1];
                    data[ord] = val;
                } catch(e) {}
            }
        }
...
exports = module.exports = CSSHttpRequest;
exports.name = "csshttprequest";